...
const Router = {
  ...
  render(page) {
    ...
    const titles = { dashboard: 'Dashboard', penerimaan: 'Barang Masuk', putaway: 'Put Away', pemakaian: 'Barang Keluar', 'stock-balance': 'Stock Balance', 'master-data': 'Master Data', 'qr-labels': 'Cetak Label QR', riwayat: 'Riwayat Transaksi', opname: 'Stock Opname', 'cek-barang': 'Cek Barang', koreksi: 'Koreksi Stock', 'alert-order': 'Alert Order', orderan: 'Orderan', users: 'Kelola User', pengaturan: 'Pengaturan', reservasi: 'Reservasi Sparepart', 'spk-online': 'SPK Online' };
