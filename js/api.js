...
const Api = {
  ...
  deleteUser: (payload) => callApi('deleteUser', payload),
  savePenerimaan: (payload) => callApi('savePenerimaan', payload),
  getStockHint: (payload) => callApi('getStockHint', payload),
  scanSPB: (payload) => callApi('scanSPB', payload),
  getDashboard: () => callApi('getDashboard'),
  getValueStockChart: () => callApi('getValueStockChart'),
  saveValueStock: (payload) => callApi('saveValueStock', payload),
  ...
  getValueStockTarget: () => callApi('getValueStockTarget'),
  saveValueStockTarget: (payload) => callApi('saveValueStockTarget', payload),
